...
function Reserve() {
  ...
  async function getLockerInfo() {
    await axios
      ...
      .then((res) => {
        ...
        setStartTime(
          res.data.result.lockersInfo[0].locker.startReservationTime
        );
  ...
  const connectSSE = () => {
    const url =
      "api/v2/sse/connect/lockers?majorId=" + encodeURI(userObj.majorId);
  ...
  const reserveURL = `api/v2/users/${userObj.userId}/majors/${userObj.majorId}/lockerDetail/`;
          ...
          <div className="reserveDiv">
            ...
            >
              ...
              >
                ...
                >
                  예약 가능 시간 : {formatDateTime(startTime)} ~{" "}
            ...
            <ChangeLockerModal
              ...
              changeLockerModal={changeLockerModal}
            ></ChangeLockerModal>
            <AlertReserveModal
              setAlertReserveModal={setAlertReserveModal}
              place={reserveName}
              num={reserveNum}
              alertReserveModal={alertReserveModal}
            ></AlertReserveModal>
            <PrevReserveModal
              setPrevReserveModal={setPrevReserveModal}
              prevReserveModal={prevReserveModal}
            ></PrevReserveModal>
            <NonetargetModal
              setNonetargetModal={setNonetargetModal}
              nonetargetModal={nonetargetModal}
            ></NonetargetModal>
          </div>
        </div>
      </ContentContainer>
