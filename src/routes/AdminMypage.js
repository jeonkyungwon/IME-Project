...
function AdminMypage() {
  ...
  const fileUploadURL = `admin/api/v2/users/${userObj.userId}/file`;
  ...
  const updateInfo = (e) => {
    const updateURL = "admin/api/v2/users";
                      ...
                      >
                        ...
                        <td>
                          <input
                            ...
                            id={`admin${i}`}
                            defaultChecked={
                              info.userInfo.role === "ROLE_ADMIN" ? true : false
                            }
                            onClick={() => {
                              let copyInfo = [...studentInfo];
